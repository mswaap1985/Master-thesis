...
{\huge \bfseries A positive sum to protect citizens by making use of cryptography technologies\par}\vspace{0.4cm}
...
{\it 2nd reader:}       & ~~dr. Remco de Boer
\end{tabular}
...
\begin{center}
\textit{Assessing suitability of encryption technologies to prevent identity fraud​}
\end{center}
